...
public class classMain extends javax.swing.JFrame {
    ...
    public classMain(int total, int[][] ad1, int[][] ad2, int[][] I1, int[][] I2, int[][] II1, int[][] II2, int[][] III1, int[][] III2,int[] lim1)
    {
        tot=total;
    ...
    // class 4 se aaya hai
    public classMain(int[][] ad1, int[][] ad2, int[][] I1, int[][] I2, int[][] II1, int[][] II2, int[][] III1, int[][] III2,int[] lim1) {
...
//        if(bName.equals("Auditorium") && lim[2]==0) lim[2]=tot;
//        if(bName.equals("CC-I") && lim[4]==0) lim[4]=tot;
//        if(bName.equals("CCtwo") && lim[6]==0) lim[6]=tot;
//        if(bName.equals("CC-III") && lim[8]==0) lim[8]=tot;
        
        class1 c1=new class1(tot,bName,cnt,adc,adg,Ic,Ig,IIc,IIg,IIIc,IIIg,lim);
        c1.setVisible(true); 
...
//        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(items));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(bName.equals("Auditorium")) jLabel4.setText(""+(lim[2]));
        if(bName.equals("CC-I")) jLabel4.setText(""+(lim[4]));
        if(bName.equals("CCtwo")) jLabel4.setText(""+(lim[6]));
        if(bName.equals("CC-III")) jLabel4.setText(""+(lim[8]));
...
//        bName=jTextField2.getText();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        SetLimit sl=new SetLimit(adc,adg,Ic,Ig,IIc,IIg,IIIc,IIIg,lim);
        sl.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        class4 c4=new class4(adc,adg,Ic,Ig,IIc,IIg,IIIc,IIIg,lim);
        c4.setVisible(true);
